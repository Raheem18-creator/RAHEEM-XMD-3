...
const port = process.env.PORT || 9090;
  ...
  try {
    ...
    console.log("📬 Followed RAHEEM newsletter.");
  } catch (e) {
...
╭══════════════⊷
┃ 🪆𝗥𝗘𝗣𝗢
┃https://github.com/Raheem18-creator/RAHEEM-XMD-3
╰══════════════⊷
╭══════════════⊷
┃ ❤️‍🩹𝗦𝗘𝗦𝗦𝗜𝗢𝗡 𝗜𝗗
...
┃+255763111390
╰══════════════⊷`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/px3vuw.jpg` }, caption: up })
  }
  })
