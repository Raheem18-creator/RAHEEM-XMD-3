...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "yoh",
// add your Session Id 
...
STICKER_NAME: process.env.STICKER_NAME || "RAHEEM-XMD-3",
...
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© powered by Raheem18-creator*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/px3vuw.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> AM ACTIVE *RAHEEM-XMD-3*⚡",
// add alive msg here 
